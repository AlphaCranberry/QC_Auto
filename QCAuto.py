...
parser.add_argument("-s",
                    "--starAlign", 
                    help="use the STAR aligner for analysis. Must include thuis or Hisat2 for program to run",
                    action="store_true", 
                    default=False)
...
while maybe == True:
    ...
    os.chdir(parentDir)
    #just try running it in raw file
    statsCmd = 'getHomerQCstats.pl -k QC/sampleInfoFile.txt > QC/stats.txt'
    os.system(statsCmd)
    ...
    g.savefig(f'{output}/RNA_Length_Plots.png')
